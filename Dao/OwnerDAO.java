...
public class OwnerDAO {
	...
	public int insert(Student newOnr) {

		String sql = "INSERT INTO OwnerUser (studentId, name, password) VALUES (?, ?, ?)";
	    Object[] param = new Object[] { newOnr.getStudentId(), newOnr.getName(), newOnr.getPassword() };	
	...
	public int updatePassword(String id, String pwd) {
		...
		String sql = "UPDATE StudentUser SET password = ? WHERE owner_Id = ?";
	...
	public int delete(String id) {
		String sql = "DELETE FROM StudentUser WHERE owner_Id = ?";
